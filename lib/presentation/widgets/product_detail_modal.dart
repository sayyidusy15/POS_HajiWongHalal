                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          Expanded(child: _buildSizeCard('Regular', '+ Rp 0')),
                          const SizedBox(width: 12),
                          Expanded(
                            child: _buildSizeCard(
                              'Large',
                              '+ ${_formatRupiah(_largePriceAdd)}',
                            ),
                          ),
                        ],
                      ),
                      ...
                      _buildAddonRow(
                        'Extra onions',
                        '+ ${_formatRupiah(_addonsPrice['Extra onions']!)}',
                      ),
                      const SizedBox(height: 8),
                      _buildAddonRow(
                        'Extra Cheese',
                        '+ ${_formatRupiah(_addonsPrice['Extra Cheese']!)}',
                      ),
                      const SizedBox(height: 8),
                      _buildAddonRow(
                        'Extra Fried Egg',
                        '+ ${_formatRupiah(_addonsPrice['Extra Fried Egg']!)}',
                      ),
                      const SizedBox(height: 20),
